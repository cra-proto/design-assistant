...
export const AI_FREE_MODELS = ['openrouter/free', 'nvidia/nemotron-3-ultra-550b-a55b:free', 'openai/gpt-oss-20b:free', 'nvidia/nemotron-3-super-120b-a12b:free'] as const;
