...
import { IaState } from '../views/ia-assistant/services/ia-state.service';
...
export class CloudStorageService {
     ...
     */
    async saveProject(projectState: IaState, projectId?: string): Promise<string | null> {
        ...
        try {
            ...
            if (projectState.iaData?.iaTree) {
                countPages(projectState.iaData.iaTree);
            }
